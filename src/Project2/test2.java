...
public class test2 {
    ...
    public void leastRecentlyUsedIsCorrect () {
        ...
        Cache<Integer,Integer> cache = new LRUCache2<>(provider, 5);
        for (int i = 0; i < 5; i++){
    ...
    public void allButOneMisses(){
        MyDataProvider provider = new MyDataProvider(); // Need to instantiate an actual DataProvider
        Cache<Integer,Integer> cache = new LRUCache2<>(provider, 1);
    ...
    public void replaceAllValues(){
        MyDataProvider provider = new MyDataProvider(); // Need to instantiate an actual DataProvider
        Cache<Integer,Integer> cache = new LRUCache2<>(provider, 1000);
    ...
    public void testConstantTimeEviction(){
        ...
        for (int i = 1; i <= ITERATIONS; i++){
            MyDataProvider provider = new MyDataProvider(); // Need to instantiate an actual DataProvider
            Cache<Integer,Integer> cache = new LRUCache2<>(provider, i * 1000);
    ...
    public void testConstantTimeGet(){
        ...
        for (int i = 1; i <= ITERATIONS; i++){
            MyDataProvider provider = new MyDataProvider(); // Need to instantiate an actual DataProvider
            Cache<Integer,Integer> cache = new LRUCache2<>(provider, i * 10000);
