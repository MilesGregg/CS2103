...
public class SimpleExpressionParser implements ExpressionParser {
	...
	private Expression parseA (String str) {
		...
		// try parseing the string as an additive expression
		expression = parseHelper(str, '+', this::parseA, this::parseM);

		// try parsing the string as a subtractive expression
		if (expression == null) {
			expression = parseHelper(str, '-', this::parseA, this::parseM);
		}
	...
	private Expression parseM (String str) {
		...
		// try parsing the string as a multiplicative expression
		expression = parseHelper(str, '*', this::parseM, this::parseE);

		// try parsing the string as a division expression
		if (expression == null) {
			expression = parseHelper(str, '/', this::parseM, this::parseE);
		}
	...
	protected Expression parseE (String str) {
		...
		// try parsing the string as a exponential expression
	...
	protected Expression parseP(String str) {
		...
		// try parsing the string as a parenthetical expression
	...
	private Expression parseHelper (String string,
		...
		for (int i = 0; i < string.length(); i++) {
			...
			if (string.charAt(i) == op) {
				// try to parse the left and right parts of the string as expressions
